...
func _launch_fireball():
	...
	fireball.apply_impulse($Volcano_Collisions/ref_skeleton/Skeleton3D.get_bone_pose_position(2), launch_direction * launch_force * globa)  # Aplicar fuerza para lanzar la bola de fuego
